...
// ============================================
// ДАННЫЕ ДЛЯ AI vs Real
// ============================================
const videoData = [
    { 
        id: "real1", 
        title: "Новостной репортаж", 
        description: "Видео A - Новостной репортаж (30 сек)", 
        isAI: false,
    ...
    { 
        id: "ai1", 
        title: "Интервью", 
        description: "Видео B - Интервью (45 сек)", 
        isAI: true,
        embedUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ"
    },
    { 
        ...
        description: "Видео C - Пресс-конференция (60 сек)", 
        isAI: false,
        embedUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ"
    },
    { 
    ...
    { 
        id: "real3", 
        title: "Реклама", 
        description: "Видео E - Реклама (25 сек)", 
        isAI: false,
        embedUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ"
    }
];
...
function getCookie(name) {
    ...
    for(let i = 0; i < ca.length; i++) {
        ...
        if (c.indexOf 0) return c.substring(nameEQ.length, c.length);
    }
    return null;
}

function initCookies() {
    // Устанавливаем куки при первом посещении
    if (!getCookie('cyberguard_visited')) {
        setCookie('cyberguard_visited', 'true', 365);
        console.log('Добро пожаловать! Куки установлены.');
    }
}
...
function downloadCertificate() {
    ...
    if (typeof html2canvas === "undefined") {
        ...
        script.src = "https://html2canvas.hertzen.com/dist/html2canvas.min.js = true;
...
function checkLinkSafety() {
 ...
 = document.getElementById("link-analysis");
    ...
    try {
        ...
        if (isHttps) {
            ...
            li.textContent = "Отсутствует HTTPS перехвачены";
            analysisList.appendChild(li);
        }
    ...
    setTimeout(() => {
        ...
        if (hasBreach) {
            ...
            recEl.innerHTML = `
                ...
                <li>Проверьте другие аккаунты сем</li>
            `;
            ...
            document.getElementById("recommendations-list").innerHTML = `
                <олжайте использовать надёжные пароли</li>
