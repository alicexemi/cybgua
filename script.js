...
const phishingEmails = [
    ...
    { from: 'noreply@gosuslugi.ru', subject: 'Ваше заявление рассмотрено', body: '<p>Здравствуйте!</p><p>Ваше заявление №123456 рассмотрено. Результат доступен в личном кабинете.</p><p><a href="#" class="phishing-link">gosuslugi.ru</a></p><p>Портал Госуслуг</p>', isPhishing: false, indicators: [] },
    ...
    { from: 'info@vk.com', subject: 'Новое сообщение от друга', body: '<p>Вам пришло новое сообщение от Ивана Петрова.</p><p><a href="#" class="phishing-link">vk.com/im</a></p><p>Команда ВКонтакте</p>', isPhishing: false, indicators: [] },
    ...
    { from: 'support@yandex.ru', subject: 'Обновление условий использования', body: '<p>Мы обновили условия использования сервиса.</p><p><a href="#" class="phishing-link">yandex.ru/legal</a></p><p>Команда Яндекса</p>', isPhishing: false, indicators: [] }
];
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Фишинг симулятор кнопки
    document.getElementById("btn-phishing")?.addEventListener("click", () => submitPhishingAnswer('phishing'));
    document.getElementById("btn-legitimate")?.addEventListener("click", () => submitPhishingAnswer('legitimate'));
    document.getElementById("btn-next-phishing")?.addEventListener("click", nextPhishingEmail);
